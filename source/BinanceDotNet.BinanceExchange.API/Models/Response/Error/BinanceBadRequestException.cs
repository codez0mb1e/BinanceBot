namespace BinanceExchange.API.Models.Response.Error
{
    ...
    {
        public BinanceBadRequestException(BinanceError errorDetails) : base(
            "Malformed requests are sent to the server. Please review the request object/string", errorDetails)
        {
        }
    }
}