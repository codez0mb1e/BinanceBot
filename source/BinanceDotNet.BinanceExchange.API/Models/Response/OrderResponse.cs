...
namespace BinanceExchange.API.Models.Response
{
    ...
    public class OrderResponse : IResponse
    {
        ...
        [DataMember(Order = 2)] public long OrderId { get; set; }

        [DataMember(Order = 3)] public string ClientOrderId { get; set; }
        ...
        [DataMember(Order = 8)] public TimeInForce TimeInForce { get; set; }

        [JsonConverter(typeof(StringEnumConverter))]
        [DataMember(Order = 9)]
        public OrderType Type { get; set; }

        [DataMember(Order = 10)] public OrderSide Side { get; set; }
        ...
        [DataMember(Order = 14)] public bool IsWorking { get; set; }
    }
}