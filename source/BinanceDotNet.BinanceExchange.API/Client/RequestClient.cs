...
namespace BinanceExchange.API.Client
{
    internal static class RequestClient
    {
        ...
        /// <returns></returns>
        public static async Task<HttpResponseMessage> SignedGetRequest(Uri endpoint, string apiKey, string secretKey,
        ...
        /// <param name="receiveWindow"></param>
        /// <returns></returns>
        public static async Task<HttpResponseMessage> SignedPostRequest(Uri endpoint, string apiKey, string secretKey,
            string signatureRawData, long receiveWindow = 5000)
        {
        ...
        /// <param name="receiveWindow"></param>
        /// <returns></returns>
        public static async Task<HttpResponseMessage> SignedDeleteRequest(Uri endpoint, string apiKey, string secretKey,
            string signatureRawData, long receiveWindow = 5000)
        {
