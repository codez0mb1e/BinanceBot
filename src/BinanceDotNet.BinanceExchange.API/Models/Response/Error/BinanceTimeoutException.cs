namespace BinanceExchange.API.Models.Response.Error
{
    ...
    {
        public BinanceTimeoutException(BinanceError errorDetails) : base(
            " request was valid, the server went to execute but then timed out. This doesn't mean it failed, and should be treated as UNKNOWN.",
            errorDetails)
        {
        }
    }
